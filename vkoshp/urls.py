...
urlpatterns = [
    ...
    path("process_invoices/accept/<int:handleinvoice_id>/", views.process_invoices_accept, name="process_invoices_accept"),
    path("process_invoices/decline/<int:handleinvoice_id>/", views.process_invoices_decline, name="process_invoices_decline"),
